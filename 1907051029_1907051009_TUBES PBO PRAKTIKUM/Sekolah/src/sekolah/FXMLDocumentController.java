...
public class FXMLDocumentController implements Initializable {
    ...
    @FXML
    private TableColumn<data,String> colno_telp;
    @FXML
    ...
    public ObservableList<data> getdataList(){
        ...
        data users;
        while (rs.next()){
            users = new data(rs.getInt("nik"),rs.getString("nama"),rs.getString("jenis_kelamin"),rs.getString("jabatan"),rs.getString("status"),rs.getString("no_telp"),rs.getString("alamat"));
            datalist.add(users);
        }
         }catch (Exception ex){ 
             ex.printStackTrace();
    ...
    public void showdata(){
         ...
         colno_telp.setCellValueFactory(new PropertyValueFactory<data,String>("no_telp"));
    ...
    private void updateData() {
        String query = "UPDATE users SET status = '"+tfstatus.getText()+ "',jabatan='"+tfjabatan.getText()+"',no_telp = '"+tftlp.getText()+"'WHERE nik = "+tfnik.getText()+"";
        executeQuery(query);
        showdata();
    }
